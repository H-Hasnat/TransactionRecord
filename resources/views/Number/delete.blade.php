...
<div id="delete-number-Modal" class="modal fade p-4">
    <div class="modal-dialog modal-confirm">
      <div class="modal-content p-4">
        ...
        <input type="text" id="deletenumberId" class="d-none">
        <div class="m-4">
          <button type="button" class="btn btn-info" id="delete-customer-modal" data-bs-dismiss="modal">Cancel</button>
          <button type="button" onclick="DeleteNumber()" class="btn btn-danger">Delete</button>
        </div>
      </div>
    </div>
  </div>
...
<script>
    ...
    async function DeleteNumber(){
        let id=document.getElementById('deletenumberId').value
        console.log(id)
...
if (overlay) {
    ...
    setTimeout(async function() {
        let res=await axios.post('/number_destroy',{id:id})
